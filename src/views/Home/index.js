...
const Home = props => (
  <div className={cx('home-banner')}>
    <p style={{ textAlign: 'center' }}>
      ...
      Maurizzle doggy izzle turpis. Vestibulum in tortizzle. Pellentesque get down get down rhoncus
      nisi. In hizzle sure platea dictumst. Donec dapibizzle. Brizzle da bomb dizzle, pretium yo
      mamma, mattizzle izzle
    </p>
  </div>
);
